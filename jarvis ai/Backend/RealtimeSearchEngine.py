...
# Ensure the "Data" directory and "ChatLog.json" file exist.
...
# Function to handle the chatbot's response generation using Google Search and AI.
def RealtimeSearchEngine(prompt):
    ...
    # Remove the most recent system message from the chat history.
    SystemChatBot.pop()

    return AnswerModifier(Answer)

# Main entry point of the program for interactive queries.
