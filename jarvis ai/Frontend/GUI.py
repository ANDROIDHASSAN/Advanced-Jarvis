from PyQt5.QtWidgets import (
    QApplication, QMainWindow, QTextEdit, QStackedWidget, QWidget, QLineEdit, QGridLayout, QVBoxLayout, QHBoxLayout, QPushButton, QLabel, QFrame, QSizePolicy
)
...
Assistantname = "Billu don"
current_dir = os.getcwd()
old_chat_message = ""
TempDirPath = "D:\\projects\\jarvis ai\\Frontend\\Files"
GraphicsDirPath = "D:\projects\jarvis ai\Frontend\Graphics"
...
class ChatSection(QWidget):
    def __init__(self):
        ...
        self.label = QLabel("")
        self.label.setStyleSheet("color: black; font-size:16px; margin-right: 195px; border: none; margin-top: -30px;")
    ...
    def toggle_icon(self, event=None):
        if self.toggled:
            MicButtonInitialed()
            self.load_icon(GraphicsDirectoryPath('voice.png'), 60, 50)
        else:
            self.load_icon(GraphicsDirectoryPath('mic.png'), 60, 68)
            MicButtonClosed()
...
class InitialScreen(QWidget):
    ...
    def load_icon(self, path, width=50, height=68):
        pixmap = QPixmap(path)
        new_pixmap = pixmap.scaled(width, height)
        self.icon_label.setPixmap(new_pixmap)
